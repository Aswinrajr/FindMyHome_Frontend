...
const ProviderMobileVerification = () => {
  const baseUrl = import.meta.env.VITE_PROVIDER_ROUTE;
  ...
  const handleConfirmOtp = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        navigate("/provider/signup", { state: { phoneNumber: mobile } });
      }
    } catch (error) {
...
export default ProviderMobileVerification;
