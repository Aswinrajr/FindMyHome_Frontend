        ...
        <div className="flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-12">
          <div className="md:w-1/2 flex flex-col justify-between">
            <div className="flex justify-between">
              <img src={image1} alt="Service Image 1" className="w-72 h-32 object-cover rounded" />
              <img src={image2} alt="Service Image 2" className="w-72 h-32 object-cover rounded" />
            </div>
            <div className="flex justify-between">
              <img src={image3} alt="Service Image 3" className="w-72 h-32 object-cover rounded" />
              <img src={image4} alt="Service Image 4" className="w-72 h-32 object-cover rounded" />
            </div>
          </div>
