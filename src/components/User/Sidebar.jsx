...
<div className="bg-gray-900 text-white rounded-lg shadow-lg p-6 h-full relative sm:p-4">
  ...
  <button
    ...
    className="absolute top-4 right-2 bg-slate-500 text-white px-4 py-2 rounded-lg shadow hover:bg-slate-600 sm:px-2 sm:py-1 sm:text-sm"
  >
    Clear selection
  </button>
  <div className="mb-8">
    ...
    <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap">
      {["Single", "Double", "Suite"].map((type) => (
        <label key={type} className="inline-flex items-center cursor-pointer sm:mr-4">
          <input
            type="checkbox"
